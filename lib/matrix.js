...
function Matrix (x /* : number | Array<number> */) /* : Matrix */ {
  if (
    ...
    flattenDeep([].concat(x)).some((x /* : number */) => typeof x !== 'number') ||
    // $flow_disable_line
...
Matrix.add = function (x /* : Matrix */, y /* : Matrix */) /* : Matrix */ {
  ...
  return x.map((row /* : Array<number> */, i /* : number */) /* : Array<number> */ =>
...
function innerproduct (x /* : Matrix */, y /* : Matrix */, i /* : number */) /* : number */ {
  ...
  const _y /* : Array<number> */ = unzip(y.__value) === [] ? unzip([y.__value])[i] : unzip(y.__value)[i]
  return [].concat(_x).reduce((z /* : number */, _z /* : number */, j /* : number */) /* : number */ => z + _z * _y[j], 0)
}
...
Matrix.multiply = function (x /* : Matrix */, y /* : Matrix */) /* : Matrix */ {
   ...
   * @const {Matrix}
   */
  const z /* : Matrix */ = Matrix(fill(
    Array(x.countRows()),
    x.countRows() !== 1 ? fill(Array(y.countColumns()), 0) : 0
  ))
  return z.map((_z /* : number | Array<number> */, i /* : number */) /* : number | Array<number> */ => {
...
Matrix.prototype.inspect = function () /* : string */ {
  switch (this.countRows()) {
    ...
    default:
       ...
       * @constant {string}
       */
      const padding /* : Array<number> */ = unzip(this.__value).map((column /* : Array<number> */) =>
