...
declare module 'lodash/fill' {
  declare export default function fill<T, U>(array: ?Array<T>, value: U, start?: number, end?: number): Array<T|U>;
}

declare module 'lodash/flattenDeep' {
  declare export default function flattenDeep<T>(array: any[]): Array<T>;
}

declare module 'lodash/padStart' {
  declare export default function padStart(string?: string, length?: number, chars?: string): string;
}

declare module 'lodash/unzip' {
  declare export default function unzip<T>(array: ?Array<T>): Array<T>;
}
